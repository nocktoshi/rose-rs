...
use rose_crypto::cheetah::{PrivateKey, PublicKey, Signature};
use rose_crypto::slip10::{derive_master_key as derive_master_key_internal, ExtendedKey};
...
pub fn sign_message(private_key_bytes: &[u8], message: &str) -> Result<WasmSignature, JsValue> {
    use rose_ztd::{Belt, Hashable, NounEncode};
